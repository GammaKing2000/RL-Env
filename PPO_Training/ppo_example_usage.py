#!/usr/bin/env python3
"""
Example usage of the PlantOS environment with a trained PPO model.
...
# Add parent directory to sys.path to allow for package imports
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Run a trained PPO agent in the PlantOS environment.',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python PPO_Training/ppo_example_usage.py "PPO_Training/models/1M_recurrent/best_model.zip"
  python PPO_Training/ppo_example_usage.py "path/to/your/ppo_model.zip"
        """
    )
